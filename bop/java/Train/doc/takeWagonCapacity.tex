...
\begin{tikzpicture}[wagon/.style={minimum width=1.2cm,minimum height=0.6cm,draw,black,thick},
  ...
  \foreach[count=\i] \c in {10,20,30,40,50} {
  ...
  \node[anchor=south] (var2) at ($ (ww4.north) + (0,.4) $) {\tt result};
  \draw[-latex] (var2.south) -- (ww4.north);

  \node at ($ (ww1.north west) ! .5 ! (w5.south east) $) {\tt Wagon result = train.takeWagonCapacity(35);};
\end{tikzpicture}
