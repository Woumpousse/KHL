...
\begin{oef}
Je stort \euros{200} op een rekening (1,2\% per jaar).
Na 7 jaar haal je het geld van de bank en stop je het in een sok onder je bed.
Wekelijks geeft oma je \euros{5} om bij het geld van de sok te stoppen.
...
\begin{enumerate}
  ...
  \item Wanneer heb je \euros{400}? Wanneer heb je \euros{1100}? 
\end{enumerate}
\end{oef}
