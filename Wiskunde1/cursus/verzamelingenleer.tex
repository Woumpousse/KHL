...
\item $X=\{a \mid a\in \mathbb{N} ~\mathrm{en}~a\leqslant 10\}$ en $Y=\{a \mid a\in \mathbb{N} ~\mathrm{en}~a>10\}$ geeft $X\union Y=\mathbb{N}$
\end{itemize}
\begin{figure}[htbp]
\centering
...
\subsection{Doorsnede of intersectie}
...
Bijvoorbeeld
\begin{itemize}
\item $X=\{a \mid a\in \mathbb{N}_0 ~\mathrm{en}~a\leqslant 8\}$ en $Y=\{a \mid a\in \mathbb{N} ~\mathrm{en}~a>5\}$ geeft $X\intersection Y=\{6,7,8\}$ (figuur~\ref{fig:doorsnede_voorbeeld})
...
\subfloat[$\{a \mid a\in \mathbb{N}_0 ~\mathrm{en}~a\leqslant 8\}\intersection \{a \mid a\in \mathbb{N} ~\mathrm{en}~a>5\}
	=\{6,7,8\}$]{
...
\begin{figure}[htbp]
\centering
\input{figuren/verzamelingen_relaties/tikz/oefeningVenn}
...
\begin{figure}[htbp]
\centering
\input{figuren/verzamelingen_relaties/tikz/oplUPQ}
...
\subfloat[oef b]{\input{figuren/verzamelingen_relaties/tikz/oplVenn3-2}}\qquad
\subfloat[oef c]{\input{figuren/verzamelingen_relaties/tikz/oplVenn3-3}}
...
\vskip2mm
\noindent Merk op dat $(A \union B)^c = A^c \intersection B^c$ en $(A \intersection B)^c = A^c \union B^c$.
\end{opl}
\end{oef}
...
\centering
%\vspace{-0.4cm}
\input{figuren/verzamelingen_relaties/tikz/oefomschrijf1}
\end{minipage}
...
\centering
%\vspace{-0.4cm}
\input{figuren/verzamelingen_relaties/tikz/oefomschrijf2}
\end{minipage}
...
\centering
%\vspace{-0.4cm}
\input{figuren/verzamelingen_relaties/tikz/oefomschrijf3}
\end{minipage}
...
\centering
%\vspace{-0.4cm}
\input{figuren/verzamelingen_relaties/tikz/oefomschrijf4}
\end{minipage}
...
\centering
%\vspace{-0.4cm}
\input{figuren/verzamelingen_relaties/tikz/oefomschrijf5}
\end{minipage}
...
\begin{figure}[htbp]
\centering
\input{figuren/verzamelingen_relaties/tikz/oefLeentje}
