...
\begin{center}
  \begin{tabular}{clp{7cm}}
    ...
    $X \times Y$ & product & $X \times Y = \{ (x, y) \;|\; x \in X \text{ en } y \in Y \}$ \\[2mm]
...
\[
  \begin{array}{rclcl}
    X \union (Y \union Z) &=& (X \union Y) \union Z &=& X \union Y \union Z \\
    X \intersect (Y \intersect Z) &=& (X \intersect Y) \intersect Z &=& X \intersect Y \intersect Z \\[2mm]
    X \union Y &=& \multicolumn{3}{l}{Y \union X} \\
    X \intersect Y &=& \multicolumn{3}{l}{Y \intersect X} \\[2mm]
    X \union (Y \intersect Z) &=& \multicolumn{3}{l}{(X \union Y) \intersect (X \union Z)} \\
    X \intersect (Y \union Z) &=& \multicolumn{3}{l}{(X \intersect Y) \union (X \intersect Z)} \\[2mm]
    (X \union Y)^c &=& \multicolumn{3}{l}{X^c \intersect Y^c} \\
    (X \intersect Y)^c &=& \multicolumn{3}{l}{X^c \union Y^c} \\[2mm]
    A \union \emptyset &=& \multicolumn{3}{l}{A} \\
    A \intersect \emptyset &=& \multicolumn{3}{l}{\emptyset} \\
    A - \emptyset &=& \multicolumn{3}{l}{A} \\
  \end{array}
\]
