...
\item Tarief I (in de 19 gemeenten van het Brussels Hoofdstedelijk Gewest): \euros{1,66}	 per km.
\item Tarief II (buiten de 19 gemeenten): \euros{2,70} per km.
\item Wachtvergoeding: \euros{30} per uur.
\item Tussen 22 en 6 uur wordt een forfaitaire meerprijs van \euros{2} gevraagd.
\end{itemize}
...
\end{align*}
Met \euros{20} geraken we dus 9,3976 km (afgerond) ver.
