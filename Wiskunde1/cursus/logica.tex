...
\begin{table}[htb]
\centering
\begin{tabular}{|r@{\ensuremath{\;\asa\;}}ll|}
  \hline
  $(p \of q)$ & $(q\of p)$ & commutativiteit \\
  $(p \en q)$ & $(q\en p)$ & commutativiteit \\
  $\left[\left(p\of q\right)\of r\right]$ & $\left[p\of\left(q\of r\right)\right]$ & associativiteit \\
  $\left[\left(p\en q\right)\en r\right]$ & $\left[p\en\left(q\en r\right)\right]$& \\
  $\left[ p\en(q\of r) \right]$ & $\left[ (p\en q)\of(p\en r) \right] $ & distributiviteit \\
  $\left[ p\of(q\en r) \right]$ & $\left[ (p\of q)\en(p\of r) \right]$ & \\
  $\niet \niet p$ & $p$ & dubbele ontkenning \\
...
\paragraph{Voorrangsregels} Bovenste bindt sterkst
\[
  \begin{array}{c}
    \toprule
    \niet \\
...
\paragraph{Tautologie\"en}
\[
  \begin{array}{r@{\quad\asa\quad}l}
    \toprule
    (p \of q) & (q\of p) \\
    (p \en q) & (q\en p) \\
    \left[\left(p\of q\right)\of r\right] & \left[p\of\left(q\of r\right)\right] \\
    \left[\left(p\en q\right)\en r\right] & \left[p\en\left(q\en r\right)\right] \\
    \left[ p\en(q\of r) \right] & \left[ (p\en q)\of(p\en r) \right] \\
    \left[ p\of(q\en r) \right] & \left[ (p\of q)\en(p\of r) \right] \\
    \niet \niet p & p \\
    \niet (p \of q) & (\niet p \en \niet q) \\
    \niet (p \en q) & (\niet p \of \niet q) \\
