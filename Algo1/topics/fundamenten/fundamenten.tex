...
\begin{frame}
  ...
  \begin{center} \small
    \begin{tabular}{llll}
      Jaar & Platform & \$/GFLOP (met inflatie) & GFLOP \\
      \toprule
...
\begin{frame}
  ...
  \begin{itemize}
    \item Basisberekeningen {\tt +}, {\tt -}, {\tt *}, {\tt /}, \dots
    \item Sequentie: berekeningen die elkaar opvolgen
    \item Selectie: berekeningen overslaan naargelang een conditie
